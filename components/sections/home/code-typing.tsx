...
import { NextDeveloper } from 'Pedram';
import { AIExpertise } from '@/skills';

function createAmazingWebsite() {
  const mySkills = {
    webDev: ["Next.js", "React", "TS", "VueJs", "Node.js"],
    aiTools: ["ChatGPT", "ML"],
    passion: "Passionate about building web applications, with a growing focus on AI integration."
  };
