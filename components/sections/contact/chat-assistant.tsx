...
const QUICK_OPTIONS: QuickOption[] = [
  {
    ...
    message: "Can you tell me about Pedram's main skills and experience?",
  },
  {
  ...
  {
    text: "💼 Past Projects",
    message: "Could you share some examples of Pedram's past projects?",
  },
  {
    text: "⚡ AI Integration",
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      role: "assistant",
      content:
        "Hi! I'm Pedram's AI assistant. I can help you learn more about her skills, experience, or how she can help with your project. What would you like to know?",
      timestamp: new Date(),
    },
  ]);
